...
import com.skysys.service.exception.base.BaseException;
import com.skysys.service.model.R;
import com.skysys.service.utils.StreamUtils;
...
public class GlobalExceptionHandler {
    ...
    public R<Void> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, HttpServletRequest request) {
        ...
        return R.fail(String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'，但输入值为：'%s'", e.getName(), e.getRequiredType()
                .getName(), e.getValue()));
    }
